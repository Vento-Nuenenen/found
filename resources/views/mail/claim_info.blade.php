                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:15px 15px 15px 15px;word-break:break-word;">
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.8;text-align:left;color:#F8F7F7;">
                                        <p>Hallo {{ empty($user->scout_name) ? $user->first_name . ' ' . $user->last_name : $user->first_name . ' ' . $user->last_name . ' / ' . $user->scout_name }}</p>
                                        <p>&#xA0;</p>
                                        <p>Es wurde eine Anfrage für einen Fundgegenstand gestellt.</p>
                                        <p>Du findest diese hier: <a href="{{ url('/') . '/admin/claims/show/' . $claim->id }}">{{ url('/') . 'admin/claims/' . $claim->id }}</a></p>
                                        <p><b>Bitte trage dich als verantwortlichen ein, wenn du den Fall übernehmen kannst!</b></p>
                                        <p>&#xA0;</p>
                                        <p>LG</p>
                                        <p>L&F</p>
                                    </div>
                            ...
                            <tr>
                                <td align="left" style="font-size:0px;padding:15px 15px 15px 15px;word-break:break-word;">
                                    <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.8;text-align:left;color:#FFFFFF;">
                                        <ul>
                                            <li>Kunde: {{ $claim->customer_name ?? 'Keine Angabe' }}</li>
                                            <li>E-Mail: {{ $claim->customer_mail ?? 'Keine Angabe' }}</li>
                                            <br />
